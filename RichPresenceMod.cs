...
namespace SVRichPresence
{
  public class RichPresenceMod : Mod
  {
    ...
    {
        { "Custom_AndyHouse", "Andy\'s House" },
        { "Custom_SophiaHouse", "Sophia\'s House" },
        { "Custom_JenkinsHouse", "Home of Olivia and Victor" },
        { "(no translation:Garden)", "Old Community Garden" },
        { "MasteryCave", "Mastery Cave" },
        { "Custom_ApplesRoom", "Apple\'s Room" },
        { "Custom_AuroraVineyard", "Aurora Vineyard" },
        { "Custom_SpriteSpringCave", "Sprite Spring Cave" },
        { "BugLand", "Mutant Bug Lair" },
        { "UndergroundMine77377", "Quarry Mine" },
        { "WitchSwamp", "Witch\'s Swamp" },
        { "WitchHut", "Witch\'s Hut" },
        { "Tent", "Linus\'s Tent" },
        { "Custom_SusanHouse", "Susan\'s House" },
        { "Custom_HighlandsOutpost", "Highlands Outpost" },
        { "SandyHouse", "Sandy\'s Store" },
        { "IslandWest", "Island West" },
        { "IslandSouth", "Island South" },
        { "IslandEast", "Island East" },
        { "IslandNorth", "Island North" },
        { "IslandHut", "Leo\'s House" },
        { "IslandFieldOffice", "Island Field Office" },
        { "VolcanoDungeon5", "Volcano Dwarf Shop" },
        { "Custom_EnchantedGrove", "Enchanted Grove" },
        { "Suburbs", "Grampleton Suburbs" },
        { "Custom_ScarlettHouse", "Scarlett\'s House" },
        { "Custom_CastleVillageOutpost", "Castle Village Outpost" },
        { "Custom_DesertRailway", "Desert Railway" },
        { "Custom_TreasureCave", "Treasure Cave" },
        { "Custom_IridiumQuarry", "Iridium Quarry" },
        { "Custom_LantanaLagoon", "Lantana Lagoon" },
        { "Custom_LantanaTemple", "Lantana Temple" },
    };
    ...
    public override void Entry(IModHelper helper)
    {
      ...
      WTag("Location", () =>
      {
          var name = Game1.currentLocation.DisplayName;

          if (CustomLocationNames.TryGetValue(name, out var fixedName))
              return fixedName;
